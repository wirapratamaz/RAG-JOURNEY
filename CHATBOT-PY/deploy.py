...
def test_chroma_connection():
    ...
    try:
        ...
        # Test connection using heartbeat instead of list_collections
        try:
            heartbeat = client.heartbeat()
            logger.info(f"ChromaDB heartbeat response: {heartbeat}")
...
def create_procfile():
    ...
    try:
        with open("../Procfile", "w") as f:
            f.write("web: cd src && python standalone_api.py\n")
